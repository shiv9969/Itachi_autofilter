...
BOT_TOKEN = environ['BOT_TOKEN',"7105712052:AAGBSbUiLzffkGu5acMxHj7zgXHdeXH45EQ
"]
...
auth_channel = environ.get('AUTH_CHANNEL', '2077157127')
auth_grp = environ.get('AUTH_GROUP', '2104914260')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '2085372939')
reqst_channel = environ.get('REQST_CHANNEL_ID', '2085372939')
...
VERIFY2_API = environ.get('VERIFY2_API', "6ac6f2011d1ce803a0f9073721e1dff72e47c0d3")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+nhJvqYPlfNI3ZThl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1971879597')).split()]
